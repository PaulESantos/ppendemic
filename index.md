# ppendemic [![](reference/figures/ppendemic_logo_web.png)](https://github.com/PaulESantos/ppendemic)
...
![](reference/figures/README-top-family-plot-1.png)
...
to check whether submitted names are listed as endemic:
...
[`is_ppendemic()`](https://paulesantos.github.io/ppendemic/reference/is_ppendemic.md)
can also be used inside tabular workflows:
...
For detailed matching diagnostics, use
[`matching_ppendemic()`](https://paulesantos.github.io/ppendemic/reference/matching_ppendemic.md):
